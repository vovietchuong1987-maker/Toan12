/* Math12 Hub V37.3.5 Variation Table & Exam Layout Polish — version-safe offline shell */
const CACHE='math12hub-v37-3-5-shell-19';
const V='37.3.5';
const CORE=[
  './','./index.html',`./manifest.webmanifest?v=${V}`,`./assets/css/app.css?v=${V}`,
  `./assets/js/mathjax-config.js?v=${V}`,`./assets/vendor/mathjax.js?v=${V}`,
  `./assets/js/core.js?v=${V}`,`./assets/js/authoring.js?v=${V}`,`./assets/js/data-vault.js?v=${V}`,`./assets/js/exam.js?v=${V}`,`./assets/js/firebase.js?v=${V}`,
