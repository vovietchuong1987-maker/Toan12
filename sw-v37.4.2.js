/* Math12 Hub V37.4.2 Pure ID6 Taxonomy UI — version-safe offline shell */
const CACHE='math12hub-v37-4-2-shell-23';
const V='37.4.2';
const CORE=[
  './','./index.html',`./manifest.webmanifest?v=${V}`,`./assets/css/app.css?v=${V}`,`./assets/css/id6-v37.4.css?v=${V}`,`./assets/css/id6-hierarchy-v37.4.1.css?v=${V}`,`./assets/css/id6-pure-ui-v37.4.2.css?v=${V}`,
