/* Math12 Hub V37.3.6 Variation Arrow Rendering Fix — version-safe offline shell */
const CACHE='math12hub-v37-3-6-shell-20';
const V='37.3.6';
const CORE=[
