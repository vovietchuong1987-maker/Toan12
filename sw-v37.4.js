/* Math12 Hub V37.4 Official ID6 Taxonomy — version-safe offline shell */
const CACHE='math12hub-v37-4-shell-21';
const V='37.4';
const CORE=[
  './','./index.html',`./manifest.webmanifest?v=${V}`,`./assets/css/app.css?v=${V}`,`./assets/css/id6-v37.4.css?v=${V}`,
