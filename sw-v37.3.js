/* Math12 Hub V37.3 Native Function Graph Engine — version-safe offline shell */
const CACHE='math12hub-v37-3-shell-14';
const V='37.3';
const CORE=[
