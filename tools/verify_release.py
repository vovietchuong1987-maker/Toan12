...
required=['sw.js','manifest.webmanifest','assets/js/security-core-v40.26.0.js','assets/js/sync-delta-v40.27.0.js','assets/js/performance-v40.28.0.js','assets/js/ux-pro-v40.29.0.js','assets/js/quality-gate-v40.30.0.js','assets/js/ux-experience-v40.31.0.js','assets/css/ux-experience-v40.31.0.css','assets/js/student-home-v40.32.0.js','assets/css/student-home-v40.32.0.css','assets/js/student-flow-v40.33.0.js','assets/css/student-flow-v40.33.0.css','assets/js/ux-consistency-v40.34.0.js','assets/css/ux-consistency-v40.34.0.css']
for rel in required:
...
for p in js:
    ...
    if p.name!='ux-consistency-v40.34.0.js':
        native=re.findall(r'(?<![\w.])(?:alert|confirm|prompt)\s*\(',txt)
        if native: errors.append(f'native alert/confirm/prompt remain in {p.name}: {len(native)}')
manifest=[]
...
print('Math12 Hub v40.34 static verification')
