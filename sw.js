...
const CORE=[
  ...
  './assets/js/authoring.js','./assets/js/exam.js','./assets/js/question-id-v40.js','./assets/js/bbt-renderer-v40.6.js','./assets/js/honor-board-v40.7.js','./assets/js/mobile-exam-v40.8.js','./assets/js/platform-v40.js',
