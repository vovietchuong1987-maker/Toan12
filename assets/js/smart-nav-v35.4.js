...
(function(){
  ...
  const PAGE_META={
    ...
    shop:{title:'Shop & Tủ đồ',subtitle:'Vật phẩm và trang phục nhân vật',icon:'🛍',keywords:'shop tủ đồ vật phẩm trang phục'},
    room:{title:'Phòng của em',subtitle:'Không gian 3D cá nhân',icon:'🏠',keywords:'phòng 3d không gian cá nhân'},
    collections:{title:'Bộ sưu tập',subtitle:'Bộ sưu tập thành tích',icon:'🗂',keywords:'bộ sưu tập thành tích huy hiệu'},
    missions:{title:'Nhiệm vụ',subtitle:'Nhiệm vụ học tập và phần thưởng',icon:'🎯',keywords:'nhiệm vụ thành tích phần thưởng'},
    journey:{title:'Hành trình',subtitle:'Mastery và tiến hóa học tập',icon:'✦',keywords:'hành trình mastery tiến hóa'},
    honor:{title:'Bảng vinh danh',subtitle:'Vinh danh toàn Math12 Hub',icon:'🏆',keywords:'bảng vinh danh thành tích top học sinh'},
