...
(function(){
  ...
  const PAGE_META={
    ...
    'learning-plan':{title:'Lộ trình của em',group:'Tiến bộ của em'},
    avatar:{title:'Nhân vật của em',group:'Thế giới của em'},
    shop:{title:'Shop & Tủ đồ',group:'Thế giới của em'},
    room:{title:'Phòng của em',group:'Thế giới của em'},
    collections:{title:'Bộ sưu tập',group:'Thế giới của em'},
    missions:{title:'Nhiệm vụ',group:'Thành tích'},
    journey:{title:'Hành trình',group:'Thành tích'},
    honor:{title:'Bảng vinh danh',group:'Thành tích'},
    ...
    progress:{title:'Tiến độ của em',group:'Tiến bộ của em'},
    analytics:{title:'Phân tích năng lực',group:'Tiến bộ của em'},
    reports:{title:'Báo cáo học tập',group:'Tiến bộ của em'},
