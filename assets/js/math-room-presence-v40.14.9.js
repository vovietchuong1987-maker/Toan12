...
(function(){
'use strict';
const BUILD='40.16.1-room-presence-spatial-fix';
...
const LOCATIONS={
  study:{label:'Bàn học',icon:'📖',pose:'study',x:-1.12,y:.38,z:.58,rotationY:0,duration:900},
  window:{label:'Cửa sổ',icon:'🌤',pose:'window',x:-3.05,y:.38,z:.55,rotationY:Math.PI/2,duration:1080},
  relax:{label:'Thư giãn',icon:'☕',pose:'seated-relax',x:1.02,y:.03,z:.12,rotationY:0,duration:1020}
};
