/* =========================================================
   Math12 Hub v40.15.0 — Avatar + Math Room Premium Layer
...
(function(){
'use strict';
const BUILD='40.15.0-avatar-room-premium',VERSION=40150;
...
function environment(profile={}){
  ...
  let phase='day',warmth=1,exposure=1.08,hemi=.82,key=1.15,window=.62;
  if(night){phase='night';warmth=.58;exposure=.84;hemi=.42;key=.48;window=.20}
  else if(hour<9){phase='morning';warmth=1.12;exposure=1.06;hemi=.76;key=1.05;window=.70}
  else if(hour>=16){phase='golden';warmth=1.18;exposure=1.02;hemi=.72;key=.98;window=.76}
  return {mode,night,phase,warmth,exposure,hemi,key,window,hour};
}
