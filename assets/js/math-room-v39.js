...
function resolvedAvatar(){const a=window.avatarV378Stored?.()||window.avatarV378Current?.()||{skin:'warm',hair:'short',outfit:'school-blue'},g=window.v385Wardrobe?.resolved?.(a)||{},out=window.AVATAR_V378_OUTFITS?.find?.(x=>x.id===a.outfit)||{top:'#4E8B59',bottom:'#204C48',accent:'#D6A721'};return {a,g,out}}
function roomAvatar(){
