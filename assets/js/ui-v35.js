/* Math12 Hub V35.4 — role-aware compact navigation (V35.2 foundation retained) */
(function(){
  ...
  function updateFooter(){const tiny=document.querySelector('.sidebar-foot .tiny');if(tiny)tiny.textContent=`V35.4 • ${roleName()} • Smart Navigation`}
