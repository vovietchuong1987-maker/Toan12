/* Math12 Hub V35.3 — role-aware compact navigation */
(function(){
  ...
  function updateFooter(){const tiny=document.querySelector('.sidebar-foot .tiny');if(tiny)tiny.textContent=`V35.3 • ${roleName()} • UX theo vai trò`}
