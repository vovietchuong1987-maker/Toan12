...
function inject(){
  ...
  const sNav=document.querySelector('[data-nav-group="student-connect"] .nav-group-items');if(sNav&&!sNav.querySelector('[data-page="honor"]'))sNav.insertAdjacentHTML('beforeend','<button data-page="honor" title="Bảng vinh danh toàn hệ thống"><span class="ico">🏆</span><span class="nav-label">Bảng vinh danh</span></button>');
